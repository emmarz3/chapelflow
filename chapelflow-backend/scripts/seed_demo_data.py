...
from apps.ministries.catalog import ensure_standard_chapel_groups  # noqa: E402
...
def seed_demo_data():
    ...
    # Keep the student self-service Fellowship and Unit join catalogue ready
    # in a fresh local setup as well as in the production bootstrap command.
    for group in ensure_standard_chapel_groups(main):
